    ...
    nitrate        = { name = 'nitrate',        label = 'Nitrate',        weight = 100,  type = 'item', image = 'nitrate.png',        unique = false, useable = false, shouldClose = true, description = 'Output from mining' },
    ...
    zinc           = { name = 'zinc',           label = 'Zinc',           weight = 100,  type = 'item', image = 'zinc.png',           unique = false, useable = false, shouldClose = true, description = 'Output from mining' },
    ...
    gold           = { name = 'gold',           label = 'Gold',           weight = 100,  type = 'item', image = 'gold.png',           unique = false, useable = false, shouldClose = true, description = 'Output from mining' },
    silver         = { name = 'silver',         label = 'Lead',           weight = 100,  type = 'item', image = 'silver.png',         unique = false, useable = false, shouldClose = true, description = 'Output from mining' },
